...
class BlogpostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blogpost" do
    assert_difference('Blogpost.count') do
      post blogposts_url, params: { blogpost: {  } }
    end

    assert_redirected_to blogpost_path(Blogpost.last)
  end
  ...
  test "should update blogpost" do
    patch blogpost_url(@blogpost), params: { blogpost: {  } }
    assert_redirected_to blogpost_path(@blogpost)
  end
